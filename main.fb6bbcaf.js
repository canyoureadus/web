...
function getChar() {
  ...
  // );
  return pick("sym-btc-s", "sym-eth-s", "sym-ltc-s", "exc-uniswap-v2-s", "sym-doge-s", "sym-ada-s", "sym-xrpx-s", "sym-bnb-s", "sym-link-s", "sym-shib", "sym-fil-s", "sym-icp-s", "sym-xlm-s", "sym-xmr-s", "sym-aave-s", "sym-lend-s");
}
  ...
  _createClass(Trail, [{
    ...
    value: function move() {
      ...
      for (var _i = 0; _i < size; ++_i) {
        var item = this.list[offset + _i - size + 1];
        this.body.push(item);
      }
    ...
    value: function drop() {
      ...
      loop(function () {
        ...
        trail.traverse(function (c, i, last) {
          c.element.style = "\n          color: hsl(32, 100%, ".concat(85 / len * (i + 1), "%);\n        ");
